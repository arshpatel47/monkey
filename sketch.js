...
function setup() {
  ...
  gameOver=createSprite(width/2,height-400,10,10)
  gameOver.addImage(gameOver_img);
  gameOver.scale=1.5;
  
  //To create restart 
  restart=createSprite(width-380,height-320,10,10);
...
function draw()
{
 ...
 gameOver.visible=false;
  ...
  else if(gameState===PLAY)
  {
    ...
    else if(keyDown("UP_ARROW")&&monkey.y>height-80)
    {
...
function food()
{
  ...
  if(frameCount%150===0)
  {
    ...
    banana=createSprite(600,Math.round(random(width-480,height-130)),10,10);
    //To add image to banana
